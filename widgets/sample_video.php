...
<?php 
    ...
    <video id="kv_video" class="video-js" width="'.trim($kv_options['player_width'], "px").'" height="'.trim($kv_options['player_height'], "px").'" style="height:'.$kv_widget_height.'; width:'.$kv_widget_width.'" controls="controls" autoplay="autoplay" preload="auto" poster="'.$cover_url.'">';
